...
ctx.keymap({
    ...
    'insert rows above': Key('cmd+alt+='),
    'insert rows below': Key('ctrl+alt+i b'),
    'insert columns to the left': Key('cmd+alt+='),
    'insert columns to the right': Key('ctrl+alt+i o'),
    'delete rows': Key('cmd+alt+-'),
    'delete columns': Key('cmd+alt+-'),
    'hide row': Key('cmd+alt+9'),
    'hide column': Key('cmd+alt+0'),
    'group rows or columns': Key('alt+shift+right'),
    'ungroup rows or columns': Key('alt+shift+left'),
    'expand grouped rows or columns': Key('alt+shift+down'),
    'collapse grouped rows or columns': Key('alt+shift+up'),
